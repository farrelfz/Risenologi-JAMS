...
- Review and approve `docs/10-DEPLOYMENT.md`.
- Review and approve `docs/11-SECURITY.md`.
- Review and approve `docs/12-TESTING.md`.
...
- ADR: Authorization and role/permission model.
- ADR: Deployment, CI/CD, and environment strategy.
...
- UI information architecture is not yet approved.
